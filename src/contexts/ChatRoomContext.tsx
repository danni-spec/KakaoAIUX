...
const INITIAL_ROOMS: ChatRoom[] = [
  ...
  },
  {
    ...
    members: [
      ...
      { name: "이해수", photo: "/profile-ieun.png" },
      { name: "조유나", photo: "/profile-yuna.png" },
      { name: "정다윤", photo: "/profile-yerin.png" },
      { name: "한소영", photo: "/profile-sina.png" },
      { name: "오재혁", photo: "/profile-junhyuk.png" },
      { name: "임수정", photo: "/profile-emma.png" },
      { name: "최동현", photo: "/profile-kimminsu.png" },
      { name: "송지은", photo: "/profile-chaewon.png" },
      { name: "황민재", photo: "/profile-junhyuk.png" },
    ],
    lastMessage: "3월 캠페인 소재 시안 공유드립니다",
    lastTimestamp: Date.now() - 1000 * 60 * 25,
    unreadCount: 16,
    messages: [
      { id: "m10a", sender: "혜선", text: "3월 신규 캠페인 브리프 공유드려요. 타겟은 25-34 MZ 직장인이고 핵심 메시지는 '일상 속 작은 변화'입니다", timestamp: Date.now() - 1000 * 60 * 120 },
      { id: "m10b", sender: "유진", text: "확인했어요! 인스타 릴스 중심으로 가는 거죠? 숏폼 트렌드 반영해서 15초 컷 기획해볼게요", timestamp: Date.now() - 1000 * 60 * 110 },
      { id: "m10c", sender: "강지훈", text: "퍼포먼스 쪽은 CPC 단가 좀 올라가고 있어서 이번엔 네이버 SA보다 카카오 비즈보드 비중 높이는 게 어떨까요", timestamp: Date.now() - 1000 * 60 * 100 },
      { id: "m10d", sender: "이해수", text: "동의합니다. 지난달 카카오 비즈보드 CTR이 네이버 대비 1.8배였어요", timestamp: Date.now() - 1000 * 60 * 95 },
      { id: "m10e", sender: "me", text: "좋아요 매체 믹스는 카카오 비즈보드 40%, 인스타 30%, 유튜브 20%, 나머지 10%로 초안 잡아볼게요", timestamp: Date.now() - 1000 * 60 * 90 },
      { id: "m10f", sender: "나연", text: "랜딩페이지 디자인은 언제까지 필요할까요? 개발팀이랑 일정 조율해야 해서요", timestamp: Date.now() - 1000 * 60 * 80 },
      { id: "m10g", sender: "혜선", text: "3/18까지 1차 시안 나오면 좋겠어요. 3/25 론칭 맞추려면 그래야 할 것 같아요", timestamp: Date.now() - 1000 * 60 * 75 },
      { id: "m10h", sender: "조유나", text: "인플루언서 협찬 건은 제가 리스트업 중이에요. 팔로워 5만 이상 마이크로 인플루언서 위주로 갈게요", timestamp: Date.now() - 1000 * 60 * 65 },
      { id: "m10i", sender: "오재혁", text: "예산 관련해서 본부장님 컨펌 나왔습니다. 총 8천만원 집행 가능해요", timestamp: Date.now() - 1000 * 60 * 55 },
      { id: "m10j", sender: "한소영", text: "CRM 발송 세그먼트도 같이 정리해야 할 것 같아요. 기존 고객 리타겟팅 포함할 건가요?", timestamp: Date.now() - 1000 * 60 * 50 },
      { id: "m10k", sender: "me", text: "네 리타겟팅 포함이요. 최근 3개월 활성 유저 대상으로 카카오 알림톡 발송 계획도 넣어주세요", timestamp: Date.now() - 1000 * 60 * 45 },
      { id: "m10l", sender: "정다윤", text: "카피 시안 3개 버전 만들어봤어요. 오후에 슬랙으로 공유드릴게요", timestamp: Date.now() - 1000 * 60 * 40 },
      { id: "m10m", sender: "유진", text: "3월 캠페인 소재 시안 공유드립니다. 슬랙 #marketing-assets 채널에 올려놨어요", timestamp: Date.now() - 1000 * 60 * 25 },
    ],
  },
  {
    id: "room-init-6",
