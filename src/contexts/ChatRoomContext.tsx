...
const INITIAL_ROOMS: ChatRoom[] = [
  {
    ...
    lastMessage: "잘 모르겠으면 전화해! 같이 가자",
    lastTimestamp: Date.now() - 1000 * 60 * 3,
    unreadCount: 2,
    messages: [
      { id: "m1", sender: "이해수", text: "토요일에 올 때 쿠폰 챙겨와!", timestamp: Date.now() - 1000 * 60 * 60 * 2 },
      { id: "m2", sender: "이해수", text: "저번에 받은 카페 쿠폰 있잖아", timestamp: Date.now() - 1000 * 60 * 60 * 2 + 5000 },
      { id: "m3", sender: "me", text: "아 맞다! 알겠어 챙길게", timestamp: Date.now() - 1000 * 60 * 55 },
      { id: "m3-1", sender: "이해수", text: "ㅋㅋ 굿굿", timestamp: Date.now() - 1000 * 60 * 50 },
      { id: "m3-2", sender: "me", text: "나 지금 출발했어!", timestamp: Date.now() - 1000 * 60 * 15 },
      { id: "m3-3", sender: "이해수", text: "오 오고 있어? 어디쯤이야?", timestamp: Date.now() - 1000 * 60 * 12 },
      { id: "m3-4", sender: "me", text: "음.. 강남역 근처인데 거기서 어떻게 가야 돼?", timestamp: Date.now() - 1000 * 60 * 10 },
      { id: "m3-5", sender: "이해수", text: "10번 출구로 나와서 직진하면 돼", timestamp: Date.now() - 1000 * 60 * 8 },
      { id: "m3-6", sender: "me", text: "10번 출구? 어디있지..", timestamp: Date.now() - 1000 * 60 * 5 },
      { id: "m3-7", sender: "이해수", text: "잘 모르겠으면 전화해! 같이 가자", timestamp: Date.now() - 1000 * 60 * 3 },
    ],
  },
  {
    id: "room-init-2",
